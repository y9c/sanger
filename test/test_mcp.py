#!/usr/bin/env python3
"""Unit tests for the cfutils MCP server."""

import unittest

try:
    from cfutils import mcp_server
...
class TestMCPServer(unittest.TestCase):
    ...
    def test_tools_registered(self):
        ...
        for expected in ("read_chromatogram", "qc_metrics", "call_mutations",
                         "re_call_bases", "analyze_sequence", "trim_read",
                         "export_sequence", "plot_chromatogram"):
    ...
    def test_call_mutations_returns_variants(self):
        ...
        r = mcp_server.call_mutations(
            "./data/B5-M13R_B07.ab1", "./data/ref.fa")
