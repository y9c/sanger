#!/usr/bin/env python3
"""Unit tests for sanger export module."""

import tempfile
import unittest

from sanger.align import call_mutations
from sanger.export import batch_summary, to_fasta, to_json, to_vcf, write_batch
...
class TestExport(unittest.TestCase):
    ...
    def test_to_vcf(self):
        ...
        has_variant_line = any(
            "\t.\t" not in line and not line.startswith("#") for line in vcf.split("\n")
        )
