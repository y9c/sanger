...
from cfutils.align import call_mutations, SitePair
from cfutils.export import to_fasta, to_vcf, to_json, batch_summary, write_batch
...
class TestExport(unittest.TestCase):
    ...
    def test_to_vcf(self):
        ...
        has_variant_line = any("\t.\t" not in l and not l.startswith("#") for l in vcf.split("\n"))
